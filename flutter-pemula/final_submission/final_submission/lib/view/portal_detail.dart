...
class PortalDetail extends StatefulWidget {
  final SourceModel sourceModel;

  PortalDetail({Key key, @required this.sourceModel}) : super(key: key);

  @override
  _PortalDetailState createState() => _PortalDetailState(sourceModel);
}

class _PortalDetailState extends State<PortalDetail> {
  final SourceModel sourceModel;

  _PortalDetailState(this.sourceModel);

  @override
  void initState() {
    super.initState();
    sourceNewsBloc..getSourceNews(sourceModel.id);
  }

  @override
  void dispose() {
    sourceNewsBloc.drainStream();
    super.dispose();
  }
        ...
        children: <Widget>[
                    ...
                    child: Container(
                      decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                            image:
                                AssetImage('assets/img/${sourceModel.id}.png'),
                            fit: BoxFit.cover),
                      ),
                    ),
                  ),
          ...
          Expanded(
            child: StreamBuilder<ArticleResponse>(
              stream: sourceNewsBloc.subject.stream,
